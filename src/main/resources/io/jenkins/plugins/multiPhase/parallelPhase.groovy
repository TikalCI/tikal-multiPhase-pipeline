...
class parallelPhase implements Serializable {
    ...
    public parallelPhase(org.jenkinsci.plugins.workflow.cps.CpsScript script) {
        this.script = script
    }
    ...
    public static class ParallelPhaseImpl implements Serializable {
        ...
        ParallelPhaseImpl(script, String name = "TCI parallel", boolean failFast = false, boolean failOnError = true, boolean showStages = true, boolean showPhaseStage = false) {
        ...
        ParallelPhaseImpl(script, Map config) {
            this.script = script
            if (config == null) {
                config = [:]
            }
    ...
    String name = "Parallel phase"
    
    public void init(String name = "Parallel phase") {
        this.name = name
    }

    // public ParallelPhaseImpl init(String name = "Parallel phase", boolean failFast = false, boolean failOnError = true, boolean showStages = true, boolean showPhaseStage = false) {
    //     this.name = name
    //     this.failFast = failFast
    //     this.failOnError = failOnError
    //     this.showStages = showStages
    ...
    // public parallelPhaseImpl ParallelPhaseImpl(String id) {
    //     new parallelPhaseImpl(this, id)
    // }
